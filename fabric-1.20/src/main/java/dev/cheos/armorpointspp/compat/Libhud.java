...
public class Libhud implements LibhudApi {
	...
	static boolean playerHealth(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
	...
	static boolean absorption(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.ABSORPTION.render(ctx(graphics, baseX(screenWidth), lastHealthY));
	}
	
	static boolean absorptionOv(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.ABSORPTION_OVER.render(ctx(graphics, baseX(screenWidth), lastHealthY));
	}
	
	static boolean armorLevel(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
	...
	static boolean armorToughness(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
	...
	static boolean resistance(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.RESISTANCE.render(ctx(graphics, baseX(screenWidth), lastArmorY));
	}
	
	static boolean protection(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.PROTECTION.render(ctx(graphics, baseX(screenWidth), lastArmorY));
	}
	
	static boolean armorToughnessOv(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.TOUGHNESS_OVER.render(ctx(graphics, baseX(screenWidth), lastArmorY));
	}
	
	static boolean magicShield(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.MAGIC_SHIELD.render(ctx(graphics, baseX(screenWidth), lastArmorY));
	}
	
	static boolean armorText(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.ARMOR_TEXT.render(ctx(graphics, baseX(screenWidth), lastArmorY));
	}
	
	static boolean healthText(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
		return Components.HEALTH_TEXT.render(ctx(graphics, baseX(screenWidth), lastHealthY));
	}
	
	static boolean toughnessText(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
	...
	static boolean debug(LibhudGui gui, GuiGraphics graphics, float partialTicks, int screenWidth, int screenHeight) {
