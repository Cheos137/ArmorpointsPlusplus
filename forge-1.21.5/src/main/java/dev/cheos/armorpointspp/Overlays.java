...
public class Overlays {                                // minecraft/neo changed something in their classloading order.. need to init later as Minecraft.getInstance() returns null on <clinit>
	private static       Minecraft minecraft         ; // = Minecraft.getInstance();
	private static       IDataProvider DATA_PROVIDER ; // = new DataProviderImpl();
	private static       IRenderer RENDERER          ; // = new RendererImpl();
	...
	static void init() {
		...
		DATA_PROVIDER = new DataProviderImpl();
