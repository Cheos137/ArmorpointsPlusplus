...
@Config(modid = Armorpointspp.MODID)
public class ApppConfig {
	...
	@Config(modid = Armorpointspp.MODID, category = "representative")
	...
	@Config(modid = Armorpointspp.MODID, category = "textcolors")
	public static class ApppConfigTextCol {
		@Config.Name("resistanceFull")
		@Config.Comment({ "Color when resistance > 5", "Available: 0x000000 ~ 0xffffff [default: %s]" })
		public static String resistanceFull = "0x4c0000";
		@Config.Name("armor0")
		@Config.Comment({ "Color when armor = 0"     , "Available: 0x000000 ~ 0xffffff [default: %s]" })
		public static String armor0 = "0x3d3d3d";
		@Config.Name("armorLT25")
		@Config.Comment({ "Color when armor < 25"    , "Available: 0x000000 ~ 0xffffff [default: %s]" })
		...
		@Config.Comment({ "Color when poisoned"      , "Available: 0x000000 ~ 0xffffff [default: %s]" })
		public static String heartPoison = "0x947818";
		@Config.Name("heartWither")
		@Config.Comment({ "Color when withered"      , "Available: 0x000000 ~ 0xffffff [default: %s]" })
		public static String heartWither = "0x2b2b2b";
		@Config.Name("heart")
		@Config.Comment({ "Color normal status"      , "Available: 0x000000 ~ 0xffffff [default: %s]" })
		public static String heart = "0xff1313";
		@Config.Name("absorption")
		@Config.Comment({ "Color of absorption"      , "Available: 0x000000 ~ 0xffffff [default: %s]" })
		public static String absorption = "0xffc300";
		@Config.Name("separator")
		@Config.Comment({ "Color of separator"       , "Available: 0x000000 ~ 0xffffff [default: %s]" })
		public static String separator = "0x3d3d3d";
	}

	@Config(modid = Armorpointspp.MODID, category = "debug")
